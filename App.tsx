...
import { MarketingIcon, DesignIcon, FinanceIcon, AestheticsIcon, CodeIcon, EnglishIcon, InfinityIcon, NoMonthlyFeeIcon, CertificateIcon, UpdatesIcon, DevicesIcon, ShieldIcon, StarIcon } from './components/icons';

const WHATSAPP_LINK = "https://api.whatsapp.com/send?phone=5553991257648&text=Oi!%20Quero%20saber%20mais%20sobre%20o%20ACERVO%20NEWGEN!";

// FIX: Defined a dedicated props type for CTAButton for better type safety and clarity, which can resolve subtle type errors.
  ...
  return (
    <div className="bg-[#0D0518] text-gray-200 overflow-x-hidden">
      <main>
        ...
        <section className="relative flex flex-col items-center justify-center w-full min-h-screen px-4 pt-20 pb-10 text-center bg-gradient-to-br from-[#0D0518] via-[#1b0a37] to-[#3a1675] animate-gradient-xy overflow-hidden">
          ...
          <div className="z-10 flex flex-col items-center">
            ...
            <div className="mt-10">
              <CTAButton className="bg-gradient-to-r from-purple-600 via-pink-500 to-blue-500 glow-shadow animate-pulse">
          ...
          <div className="container px-4 mx-auto">
            <AnimatedSection>
              <div className="max-w-3xl p-8 mx-auto text-center border-2 border-dashed rounded-3xl border-pink-500/50 bg-gradient-to-br from-purple-900/30 to-pink-900/30 backdrop-blur-lg">
                ...
                <CountdownTimer />
                <div className="mt-8">
                  <CTAButton className="bg-gradient-to-r from-pink-600 to-purple-600 glow-shadow">
        ...
        <section className="py-20 bg-[#0D0518]">
          <div className="container px-4 mx-auto">
            ...
            <div className="grid max-w-4xl grid-cols-1 gap-8 mx-auto mt-12 md:grid-cols-2">
              {[
                { name: 'Juliana S.', text: 'Incrível! Nunca imaginei ter tanto conteúdo por um preço tão baixo. Já comecei a aplicar o que aprendi em design e meus freelas decolaram!', avatar: 'https://picsum.photos/id/237/100/100' },
                { name: 'Marcos P.', text: 'O melhor investimento que fiz na minha carreira. Os cursos de programação são super atualizados. O acesso vitalício é a cereja do bolo.', avatar: 'https://picsum.photos/id/238/100/100' },
      ...
      <footer className="py-8 text-center text-gray-500 border-t border-purple-900/50">
          ...
          <p className="mt-2 text-sm">Contato via WhatsApp: (53) 99125-7648</p>
      </footer>
    </div>
  );
};
